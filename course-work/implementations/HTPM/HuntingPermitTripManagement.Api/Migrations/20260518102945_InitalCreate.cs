    ...
    public partial class InitalCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuntingTrips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HuntingTrips_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HuntingTrips_Permits_PermitId",
                        column: x => x.PermitId,
                        principalTable: "Permits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HuntingTrips_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HarvestRecords_HuntingTrips_TripId",
                        column: x => x.TripId,
                        principalTable: "HuntingTrips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_HarvestRecords_TripId",
                table: "HarvestRecords",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_HuntingTrips_LocationId",
                table: "HuntingTrips",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_HuntingTrips_PermitId",
                table: "HuntingTrips",
                column: "PermitId");

            migrationBuilder.CreateIndex(
                name: "IX_HuntingTrips_UserId",
                table: "HuntingTrips",
                column: "UserId");
